	...
	<div class="container-fluid p-0">
		<div class="videofullsec">
			<div class="showvideo">
				...
				<iframe id="PLAYER1" class="embed_video" src="https://player.vimeo.com/video/<?php echo $vd_id; ?>?autoplay=0&loop=0&autopause=0&badge=0&controls=0" width="100%" height="100%" frameborder="0" allowfullscreen ></iframe>	
				<!--<div class="button-switch autoplay-btn">
					
				  	<input type="checkbox" id="switch-autoplay" class="switch">
					<label for="switch-autoplay" class="lbl-off">Off</label>
			  		<label for="switch-autoplay" class="lbl-on">On</label>
				</div>	--->
              ...
              ld_video_players[element_id].on('timeupdate', function(something) {				  
				...
				if(autopalystatus1 === true){
					...
					if(idExist == true){
						index = index +1;
					setTimeout( function(){ 						
						 window.location = 'http://kidsyoga.securework.co/all-videos/?video='+value[index]+'';
						}  , 1000 );
					}
				}
					 $.ajax({
            ...
            if ( typeof ld_video_players[element_id] !== 'undefined' ) {            
              ...
              ld_video_players[element_id].on('timeupdate', function(something) {
               ...
               //console.log('percent',percent);
                if (percent >= 0.98) {
				//console.log('Full watched the video');
					 $.ajax({
						  type:"post",
						  url:controllerPath,
						  data:{type:'watchedvideoaddtree',videoId:videoId},
